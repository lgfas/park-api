...
import com.lgfas.parkapi.jwt.JwtToken;
import com.lgfas.parkapi.web.dto.UsuarioLoginDto;
...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisValidas_RetornarTokenComStatus200 () {
        JwtToken responseBody = testClient
                ...
                .bodyValue(new UsuarioLoginDto("luis@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageStatus400 () {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("luis@email.com", "000000"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void autenticar_ComPasswordInvalido_RetornarErrorMessageStatus422 () {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("luis@email.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("luis@email.com", "123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("luis@email.com", "123456789"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
